...
{
	public Goblin(int row, int column, Grid2DMap map, AssetManager assets, Game game, int entity_id) 
	{
		super(0, 0, 1, 1, map, assets, game, entity_id);
